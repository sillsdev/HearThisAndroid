...
public class BookInfo implements Serializable {
			...
			
	{
        ...
        if (s_theOneScriptProvider != null && s_theOneScriptProvider != scriptProvider)
        	throw new UnsupportedOperationException("need to implement support for multiple script providers");
